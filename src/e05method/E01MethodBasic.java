...
public class E01MethodBasic {
	...
	/*
	 메서드1 : 반환값있고 매개변수도 있는 형태의 정의
	 => 매개변수로 2개의 정수를 전달받아 합의 결과를 반복한다.
	 반환값은 호출한 지점으로 반환된다.
	 */
	...
	/*
	 매서드3 : 반환값은 없고 매개변수는 있는 형태 정의
	 	=> 문자열을 인수로 전달받아 단순히 출력만한다. 반환값이
	 	없는 경우에는 실행이 종료되면 호출했던 지점으로 
	 	실행의 흐름이 이동된다.
	 */
	...
	//main메서드는 Java 에서 출발점(Entry point)의 역할을 한다.
	public static void main(String[] args) {
		...
		System.out.println("10과20을 전달한결과"+ simpleFunc(10,20));
