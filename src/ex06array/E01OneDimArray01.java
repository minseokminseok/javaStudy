...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		 인스턴스 배열 : 기본자료형을 저장하는 배열이 아닌 
		 인스턴스의 참조값을 저장할 목적으로 생성한 배열을 말한다.
		 사용법은 동일하다.
		 */
		...
		/*배열의 선언과 동시에 초기화 하는경우 자바 컴파일러는
		 초기 값의 갯수를 통해 배열의 크기를 결정할 수 있다. 
		 따라서 이런 경우에는 크기는 생략하도록 약속되어 있다.*/
