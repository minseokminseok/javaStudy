...
public class E01OneDimArray02 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 첫번째  0.xxx형태의 난수를 생성한후 정수로 변경위해
		 100을 곱한다.
		 두번째 45로 %연산하여 나머지를 구한다 정수를 45로 나누면
		 나머지는 0~44사이가 된다.
		 세번째 0은 구간에 포함되지 않으므로 1을 더해준다.
		 네번째 정수의 결과를 구하기 위해 int로 강제형변환한다. 
		 */
		System.out.println("1~45사이의 난수생성"+
		( (int) ( (Math.random()*100)%45)+1 ) );
		System.out.println("==================");
		
		/*크키가 6인 배열을 생성해서 난수를 저장한 후 
		 출력한다. 중복된 난수가 생성될 수 있고 정렬 또한 
		 되지 않는다.*/
		System.out.println("크기가 6인 배열에 난수입력");
		//크기가 6인 정수형 배열 생성
		int[] lottoNum = new int[6];
		//크기 만큼 반복해서 1~45사이의 난수를 생성한다.
